...
export const registrationTimeline = [
  {
    ...
    description:
      'Begin your journey by registering for the Altair optimization challenge.',
  },
  {
    id: 2,
    ...
    date: 'March 10, 2025',
    description:
      'Last date to register. Make sure to complete your registration before the deadline.',
  },
  {
    id: 3,
    ...
    date: 'March 17, 2025',
    description:
      'Last day to submit your submission. Try not to miss the deadline.',
  },
  {
    id: 4,
...
export const submissionGuidelines1 = [
  {
    ...
    description:
      'Validate your expertise in structural simulation and optimization with industry-recognized credentials for career advancement.',
  },
  {
    id: 2,
    icon: icon2,
    ...
    description:
      'Include all boundary conditions and optimization parameters in your .stmod file for full technical compliance with contest standards.',
  },
  {
    id: 3,
    icon: icon3,
    ...
    description:
      'Present a comprehensive analysis correlating simulation results with performance goals across structural, dynamic, and fluid domains.',
  },
  {
    id: 4,
    icon: icon4,
    title:
      'Submit a video recording of the process on YouTube and share the link',
    description:
      'Showcase your problem-solving approach through a narrated video, demonstrating Inspire’s capabilities in addressing the contest’s open-ended challenge.',
  },
]
...
export const submissionGuidelines2 = [
  {
    ...
    description:
      'Package all submission components (certification, .stmod file, report, and video link) into one archive. Follow naming conventions for efficient judge tracking and verification.',
  },
  {
    id: 2,
    icon: icon5,
    ...
    description:
      'Upload your optimized solution package through the official contest portal. Ensure all files are accessible and meet technical requirements before final submission.',
  },
]
